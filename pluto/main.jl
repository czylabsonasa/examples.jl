...
# ╔═╡ 04d3f124-ea85-4f4d-b9a9-864526f30f03
using Winston

# ╔═╡ 6aa2d3c4-d7dd-4959-b00d-9e5ad470d123


# ╔═╡ 1c293d83-4155-44ed-823f-accc676272e6
md"""
| xmin | xmax |
|:---:|:---:|
| $(@bind xmin html"<input type=range min=-10 max=-1 showvalue = true>") | $(@bind xmax html"<input type=range min=1 max=10>") |
"""


# ╔═╡ cee0d1d1-9393-403c-9f89-f21950214190
(xmin=xmin, xmax=xmax)


# ╔═╡ eabf36ea-0c81-4cb8-b647-5492981772e5
md"""
| ymin | ymax |
|:---:|:---:|
| $(@bind ymin html"<input type=range min=-1 max=0>") | $(@bind ymax html"<input type=range min=0.1 max=5>") |
"""

# ╔═╡ e2241931-8488-4e97-9d70-44104ba7f1d5
(ymin = ymin, ymax = ymax)

# ╔═╡ e092deca-9900-45e1-81d2-158ce3845718
md"""
| μ | σ |
|:---:|:---:|
| $(@bind μ html"<input type=range min=-10 max=10>") | $(@bind σ html"<input type=range min=1 max=10>") |
"""

# ╔═╡ f7e061e4-8c53-4740-ac4c-3eb7f3d857c2
(μ = μ, σ = σ)

# ╔═╡ 6c45c576-04be-4bdf-9701-5bcf9108e493
f(x) = 1/(σ*sqrt(2π))*exp(-(x-μ)^2/(2σ^2))

# ╔═╡ 6812e5b1-3168-4cd8-91f1-d5299edf3666
dom = collect(xmin:0.01:xmax);

# ╔═╡ 55ec6e16-b33b-4232-8068-fe95e069dd48
plot(dom, f.(dom))

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
Winston = "bd07be1c-e76f-5ff0-9c0b-f51ef45303c6"
...
[[Winston]]
deps = ["Cairo", "Colors", "Compat", "Dates", "Graphics", "Grisu", "Gtk", "IniFile", "LinearAlgebra", "NaNMath", "Pkg", "Printf", "REPL", "Random", "Reexport", "SparseArrays", "StatsBase"]
git-tree-sha1 = "35123ccb45e319ab6068a20be0ef9f358c116c8d"
