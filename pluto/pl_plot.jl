...
begin
	...
	fz(t)=t
	#fun = (fx=fx, fy=fy)
	fun = (fx=fx, fy=fy, fz=fz)
end

# ╔═╡ 328736c8-5761-4939-8267-a37bbc6416c0
@bind L Slider(10:10:500)


# ╔═╡ 98e21935-9695-446c-8ab6-0ad2e7852f58
t=range(0,stop=4π, length=L)

# ╔═╡ 24090c58-d0d6-48ff-b5dc-7e4b6e102522
@bind H Slider(1:0.2:5)

# ╔═╡ 491dc4ed-6e61-40e6-a839-7f72baefef7a
plot(fun.fx.(t), fun.fy.(t), H*fun.fz.(t),zlim=(0,15))

# ╔═╡ 286bfb4e-f496-45b3-8f08-88ee91bd10df
