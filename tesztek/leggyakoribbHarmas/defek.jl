...
function mqbruteforce(nC,D,frek1,frek2,p1,p2)
  println("qbruteforce...")
...
function mrestart(D,frek1,frek2,mx)
  ...
  for ((a,b),v) in qfrek2
    ...
    for c in 1:nC
      ...
      ((get(qfrek2,(aa,bb),0)<mx)||
        (get(qfrek2,(aa,cc),0)<mx)||
          (get(qfrek2,(bb,cc),0)<mx))&&continue
